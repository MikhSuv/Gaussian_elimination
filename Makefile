...
$(BUILDDIR)/Gaussian_elimination.o: $(BUILDDIR)/precision_mod.o

$(MAIN_OBJ): $(BUILDDIR)/precision_mod.o $(BUILDDIR)/Gaussian_elimination.o
$(TEST_OBJ): $(BUILDDIR)/precision_mod.o $(BUILDDIR)/Gaussian_elimination.o
